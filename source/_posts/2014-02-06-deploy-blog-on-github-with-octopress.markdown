...
3 进入仓库所在目录, 可以看到文件处于source分支, 继续克隆git clone git@github.com:yourname/yourname.github.com.git \_deploy, 进入目录\_deploy, 切换到master分支: git checkout master, 可以看一下，现在的文件都是博客的静态文件  
4 cd .. 退回到仓库目录  
